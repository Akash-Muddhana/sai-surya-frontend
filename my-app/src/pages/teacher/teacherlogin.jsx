...
export function TeacherLogin({ isTeacherLoggedIn, setIsTeacherLoggedIn }) {
        ...
        <section className="overflow-hidden rounded-3xl border border-white/80 bg-white/95 shadow-2xl shadow-violet-200/40">
          <div className="bg-gradient-to-r from-violet-500 via-purple-500 to-fuchsia-400 p-6 text-white">
            ...
            <p className="mt-3 text-sm leading-6 text-white/90">
              Sign in to access your classroom, manage students, and view course
              materials.
            </p>
          </div>
            ...
            <div className="rounded-2xl bg-violet-50 p-4 ring-1 ring-violet-100">
              ...
              <div className="mt-2 flex items-center gap-3">
                ...
                <p className="text-sm font-semibold leading-6 text-gray-600">
                  Teacher tools are available only after successful
                  authentication.
                </p>
              </div>
            </div>
            ...
            <label className="block">
              ...
              <div className="relative mt-2">
                ...
                <input
                  ...
                  className={`block w-full rounded-2xl border bg-white px-12 py-3 pr-14 font-semibold text-gray-900 outline-none transition ${
